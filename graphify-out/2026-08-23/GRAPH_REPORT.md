# Graph Report - iteration2  (2026-08-23)

## Corpus Check
- 478 files · ~465,376 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5304 nodes · 6697 edges · 452 communities (327 shown, 125 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 125 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5aa5dedb`
...
- `bull_portfolio()` --references--> `PortfolioState`  [EXTRACTED]
  tests/unit/test_rebalance_engine.py → src/app/core/models.py
- `test_compute_rebalance_diff_on_regime_shift()` --references--> `PortfolioState`  [EXTRACTED]
  tests/unit/test_rebalance_engine.py → src/app/core/models.py

## Import Cycles
- None detected.

## Communities (452 total, 125 thin omitted)
...
### Community 16 - ".get_history"
Cohesion: 0.29
Nodes (5): DataFrame, Series, Return a multi-asset aligned matrix (Date index, Columns = symbols) Uses NIFTY…, Get cleaned, validated OHLCV history with returns computed. Loads from local…, Get daily return series for a given ticker.

### Community 17 - "normalize_symbol"
Cohesion: 0.05
Nodes (52): get_explore_service(), get_growth_forecast(), get_stock_profile(), list_explore_stocks(), get, Request, Explore Tab REST API Routes for Stock Intelligence and Multi-Horizon Forecasts., Dependency provider for ExploreService attached to application state. (+44 more)
...
Cohesion: 0.18
Nodes (18): Enum, BenchmarkComparisonLive, MarketRegimeType, PortfolioHolding, PortfolioState, RiskPersona, create_portfolio_from_allocations(), PortfolioSimulator (+10 more)
...
### Community 45 - "ParquetMarketCache"
Cohesion: 0.08
Nodes (26): ParquetMarketCache, DataFrame, Path, High-performance Parquet-based market data cache., Return list of all cached symbols in the directory., Manages fast on-disk Parquet caching for historical OHLCV data., Derive safe file path for a symbol., Save OHLCV dataframe as a Parquet file. (+18 more)
...
### Community 59 - "test_api_routes.py"
Cohesion: 0.39
...
### Community 84 - "extract_stock_factors"
Cohesion: 0.12
...
### Community 98 - "Product Requirements Document (PRD): QuantNiti"
Cohesion: 0.12
Nodes (16): 1.1 The Problem & The Academic Panel Critique, 1.2 The Solution: QuantNiti, 1. Executive Summary & Problem Statement, 2. Core Personas & User Stories, 3.1 Tab 1: `Grow` (Investor Mode), 3.2 Tab 2: `Explore` (Stock Intelligence), 3.3 Tab 3: `Quant Lab` (Academic & Trader Studio), 3.4 Tab 4: `Portfolio` (Virtual Investment Simulator) (+8 more)
...
### Community 137 - "MarketDataService"
Cohesion: 0.04
Nodes (81): FastAPI, create_app(), FastAPI Application Factory for QuantNiti., Create and configure the FastAPI application instance., health_check(), get, Service health check endpoint., get_current_regime() (+73 more)
...
Cohesion: 0.07
Nodes (52): BacktestDataPoint, BasketAllocationItem, BasketGrowthProjections, BasketRecommendationResponse, BenchmarkComparison, BenchmarkComparisonItem, CurrentRegimeResponse, ExploreStockSummary (+44 more)

### Community 227 - "test_backtest_engine.py"
Cohesion: 0.14
...
### Community 228 - "simulation/service.py"
Cohesion: 0.17
Nodes (17): BrokerOrderItem, BrokerOrderSheet, RebalanceAlert, RebalanceItemDiff, Virtual Paper Portfolio Simulation and Rebalancing Engine., compute_rebalance_diff(), execute_rebalance(), generate_broker_order_sheet() (+9 more)
...
### Community 259 - "routes/portfolio.py"
Cohesion: 0.21
...
### Community 261 - "test_design_system_mode.py"
Cohesion: 0.16
...
### Community 290 - "PortfolioService"
Cohesion: 0.17
...
### Community 292 - "grow.py"
Cohesion: 0.24
Nodes (13): get_grow_service(), get, post, Request, Grow and AI Portfolio Basket recommendation API endpoints., Retrieve GrowService instance from application state., Generate curated AI portfolio basket via POST body., Generate curated AI portfolio basket via GET query params. (+5 more)

### Community 293 - "BacktestEngine"
Cohesion: 0.23
Nodes (11): StrategyType, BacktestEngine, compute_rsi(), Any, DataFrame, Series, Extract individual trade logs from position transitions., Execute vectorized backtest simulation. (+3 more)
...
### Community 295 - "BacktestService"
Cohesion: 0.14
Nodes (12): BacktestService, Any, Core domain service for technical strategy backtesting and quant analytics., Run technical strategy backtest simulation with performance and regime…, Run Buy & Hold strategy on NIFTY 50 benchmark., Run Moving Average Crossover strategy on a specific NIFTY 50 stock., Test date range filtering on backtest., Invalid stock symbol raises ValueError. (+4 more)

### Community 296 - "ring"
Cohesion: 0.67
Nodes (3): ring, $type, $value

### Community 297 - "MultiHorizonForecaster"
Cohesion: 0.19
...
Cohesion: 0.09
Nodes (32): apply_weight_caps(), compute_hrp_weights(), get_cluster_variance(), get_quasi_diag_order(), HRPOptimizer, DataFrame, ndarray, Hierarchical Risk Parity (HRP) Portfolio Allocation Engine. Implements the… (+24 more)
...
### Community 319 - "test_grow_api.py"
Cohesion: 0.11
Nodes (19): BaseModel, Configuration settings for QuantNiti., Settings, asyncio, Integration tests for Grow and Basket Recommendation API routes., POST /api/v1/grow/recommend returns 200 with complete recommendation schema., GET /api/v1/grow/recommend with query parameters returns 200., POST /api/v1/baskets/recommend alias route returns 200. (+11 more)
...
### Community 412 - "test_basket_growth_calculator.py"
Cohesion: 0.18
...
### Community 421 - "Component identification with data-slot"
Cohesion: 0.25
...
### Community 423 - "get_universe_metadata"
Cohesion: 0.25
Nodes (6): Return list of all universe members and benchmark indices as Pydantic models., List all NIFTY 50 stocks with summary growth projections and regime suitability., get_universe_metadata(), Any, Return list of metadata dictionaries for all stocks in the universe., test_get_universe_metadata()

### Community 424 - "test_portfolio_simulator.py"
Cohesion: 0.25
...
### Community 425 - "test_rebalance_engine.py"
Cohesion: 0.25
Nodes (7): bull_portfolio(), fixture, Unit tests for Regime-Shift Rebalance Diff Engine and Broker Order Sheet., When regime shifts to High-Volatility Bear, rebalance diff recommends defensive…, Generate Zerodha CSV and Groww text format order sheets., test_compute_rebalance_diff_on_regime_shift(), test_generate_broker_order_sheet()

### Community 426 - "2. API and Composition Vocabulary"
Cohesion: 0.29
...
### Community 445 - "muted-foreground"
Cohesion: 0.67
Nodes (3): muted-foreground, $type, $value

### Community 446 - "primary"
Cohesion: 0.67
Nodes (3): primary, $type, $value

### Community 447 - "primary-hover"
Cohesion: 0.67
Nodes (3): primary-hover, $type, $value

## Knowledge Gaps
- **2575 isolated node(s):** `fs`, `path`, `fs`, `path`, `fs` (+2570 more)
...
- **Why does `MarketDataService` connect `MarketDataService` to `models.py`, `PortfolioService`, `simulation/service.py`, `get_universe_metadata`, `BacktestService`, `ParquetMarketCache`, `.get_history`, `normalize_symbol`, `data/service.py`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `app_instance()` connect `MarketDataService` to `PortfolioService`, `test_grow_api.py`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `DesignSystemGenerator` connect `DesignSystemGenerator` to `read_rows`, `test_design_system_mode.py`, `BM25`, `detect_domain`, `search`, `.generate`, `generate_design_system`, `TestGeneratedCatalogContract`, `design_system.py`, `_style_is_dark_primary`, `BM25`?**
...
- **What connects `fs`, `path`, `fs` to the rest of the system?**
  _2575 weakly-connected nodes found - possible documentation gaps or missing edges._