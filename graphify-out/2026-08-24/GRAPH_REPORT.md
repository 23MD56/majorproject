# Graph Report - iteration2  (2026-08-24)

## Corpus Check
- 502 files · ~487,622 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5517 nodes · 6982 edges · 469 communities (335 shown, 134 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 129 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a08c2b63`
...
2. `MarketDataService` - 55 edges
3. `DesignSystemGenerator` - 48 edges
4. `search()` - 46 edges
5. `RegimeService` - 40 edges
...
- `app()` --calls--> `create_app()`  [EXTRACTED]
  tests/integration/test_api_routes.py → src/app/api/app.py
- `test_app()` --calls--> `create_app()`  [EXTRACTED]
  tests/integration/test_client_serving.py → src/app/api/app.py

## Import Cycles
- None detected.

## Communities (469 total, 134 thin omitted)
...
Cohesion: 0.09
Nodes (43): Enum, BasketAllocationItem, BasketGrowthProjections, BenchmarkComparisonItem, CreatePortfolioRequest, MarketRegimeType, BaseModel, Pydantic data models and schemas for QuantNiti. (+35 more)

### Community 18 - "accessibility.mdx"
Cohesion: 0.08
Nodes (23): ARIA Patterns, Color and Contrast, Color Independence, Common ARIA Attributes, Common Pitfalls, Contrast Requirements, Disabled Form Elements, Empty Buttons (+15 more)

### Community 19 - "generate_design_system"
Cohesion: 0.25
...
Cohesion: 0.10
Nodes (19): 1. Semantic HTML Flexibility, 2. Component Reusability, 3. Accessibility Improvements, 4. Style System Integration, Common Pitfalls, Common Use Cases, Discriminated Unions, Generic Component Types (+11 more)
...
Cohesion: 0.16
Nodes (18): BenchmarkComparisonLive, PortfolioHolding, PortfolioState, Virtual Paper Portfolio Simulation and Rebalancing Engine., create_portfolio_from_allocations(), PortfolioSimulator, Any, Virtual Paper Portfolio Simulator and Mark-to-Market Valuation Engine. (+10 more)
...
### Community 45 - "test_api_routes.py"
Cohesion: 0.39
...
### Community 59 - "app.js"
Cohesion: 0.08
Nodes (22): activateBasketToPortfolio(), applyRebalance(), AppState, backtestCurrentStock(), checkRebalanceDiff(), closeStockProfileModal(), filterBySector(), filterStocks() (+14 more)
...
### Community 70 - "Styling state with data-state"
Cohesion: 0.17
...
Cohesion: 0.06
Nodes (52): DatetimeIndex, get_history(), get_market_service(), get_quote(), get_returns_matrix(), get_universe(), BaseModel, get (+44 more)
...
### Community 137 - "ParquetMarketCache"
Cohesion: 0.06
Nodes (34): ParquetMarketCache, DataFrame, Path, High-performance Parquet-based market data cache., Return list of all cached symbols in the directory., Manages fast on-disk Parquet caching for historical OHLCV data., Derive safe file path for a symbol., Save OHLCV dataframe as a Parquet file. (+26 more)
...
### Community 209 - "Spec: QuantNiti Core Platform"
Cohesion: 0.22
Nodes (8): Further Notes, Implementation Decisions, Out of Scope, Problem Statement, Solution, Spec: QuantNiti Core Platform, Testing Decisions, User Stories

### Community 210 - "provider.py"
Cohesion: 0.05
Nodes (30): ABC, MarketDataProvider, MockDataProvider, Any, DataFrame, Market data providers for QuantNiti (Yahoo Finance and Mock Provider)., Deterministic synthetic market data provider for offline testing and…, Derive reproducible integer seed from symbol string. (+22 more)

### Community 211 - "MarketRegimeClassifier"
Cohesion: 0.12
...
Cohesion: 0.05
Nodes (52): get_current_regime(), get_regime_history(), get_regime_service(), BaseModel, get, post, Request, Market Regime REST API Routes. (+44 more)

### Community 227 - "rebalance.py"
Cohesion: 0.14
Nodes (18): BrokerOrderItem, BrokerOrderSheet, RebalanceAlert, RebalanceItemDiff, compute_rebalance_diff(), generate_broker_order_sheet(), Any, Regime-Shift Rebalance Diff Engine and Broker Order Sheet Generator. (+10 more)
...
### Community 259 - "test_design_system_mode.py"
Cohesion: 0.16
...
### Community 261 - "routes/portfolio.py"
Cohesion: 0.21
...
### Community 270 - "test_grow_api.py"
Cohesion: 0.18
Nodes (13): app_instance(), asyncio, fixture, Integration tests for Grow and Basket Recommendation API routes., Create FastAPI application with services attached., POST /api/v1/grow/recommend returns 200 with complete recommendation schema., GET /api/v1/grow/recommend with query parameters returns 200., POST /api/v1/baskets/recommend alias route returns 200. (+5 more)
...
### Community 288 - "DiscreteAllocationEngine"
Cohesion: 0.23
...
### Community 290 - "Component identification with data-slot"
Cohesion: 0.25
...
Cohesion: 0.11
Nodes (26): get_grow_service(), get, post, Request, Grow and AI Portfolio Basket recommendation API endpoints., Retrieve GrowService instance from application state., Generate curated AI portfolio basket via POST body., Generate curated AI portfolio basket via GET query params. (+18 more)

### Community 296 - "ring"
Cohesion: 0.67
Nodes (3): ring, $type, $value

### Community 297 - "_suggest_identities"
Cohesion: 0.25
...
### Community 410 - "app.py"
Cohesion: 0.05
Nodes (56): FastAPI, create_app(), FastAPI Application Factory for QuantNiti., Create and configure the FastAPI application instance., get_backtest_service(), get, post, Request (+48 more)

### Community 411 - "_style_is_dark_primary"
Cohesion: 0.18
Nodes (8): _query_wants_dark(), True when a styles.csv row describes itself as dark-first., True when the query explicitly asks for a dark theme., Resolve the mode the rest of the output has to agree with., _resolve_color_mode(), _style_is_dark_primary(), TestModeResolution, read_rows()

### Community 412 - "test_pwa_integration.py"
Cohesion: 0.17
Nodes (14): asyncio, fixture, Integration tests for PWA endpoints, headers, manifests, and client DOM…, Verify /manifest.json is served with application/manifest+json MIME type and…, Verify /sw.js is served with application/javascript and Service-Worker-Allowed:…, Verify /offline.html is served successfully., Verify icon PNG and SVG assets are accessible via HTTP., Verify index.html includes manifest link, Apple meta tags, install button, and… (+6 more)
...
### Community 424 - "padding-y"
Cohesion: 0.67
Nodes (4): padding-y, padding-y, $type, $value

### Community 437 - "test_portfolio_simulator.py"
Cohesion: 0.25
...
### Community 440 - "test_end_to_end_integration.py"
Cohesion: 0.19
Nodes (12): asyncio, fixture, Comprehensive End-to-End Integration Tests for QuantNiti 4-Tab Workflows., End-to-End Journey 2: 1. Search & Filter stocks in Explore Tab. 2. Retrieve…, End-to-End Journey 3: Verifies that all 5 technical trading strategies…, End-to-End Journey 4: Verifies Market Regime radar and historical timeline…, End-to-End Journey 1: 1. Check Market Regime. 2. Generate AI Basket…, test_app() (+4 more)

### Community 441 - ".get_portfolio"
Cohesion: 0.40
Nodes (3): Evaluate and return regime-shift rebalance recommendations., Apply recommended rebalance and update portfolio state., Retrieve portfolio and refresh mark-to-market valuations.

### Community 442 - "Component Patterns"
Cohesion: 0.40
Nodes (5): Component Patterns, Dropdown Menu, Forms, Modal/Dialog, Tabs

### Community 443 - "Best Practices"
Cohesion: 0.40
...
### Community 445 - "Implementation Methods"
Cohesion: 0.40
...
### Community 454 - "foreground"
Cohesion: 0.67
Nodes (3): foreground, $type, $value

### Community 455 - "muted-foreground"
Cohesion: 0.67
Nodes (3): muted-foreground, $type, $value

### Community 456 - "primary"
Cohesion: 0.67
Nodes (3): primary, $type, $value

### Community 457 - "primary-hover"
Cohesion: 0.67
Nodes (3): primary-hover, $type, $value

### Community 459 - "forecasting/service.py"
Cohesion: 0.06
Nodes (55): get_explore_service(), get_growth_forecast(), get_stock_profile(), list_explore_stocks(), get, Request, Explore Tab REST API Routes for Stock Intelligence and Multi-Horizon Forecasts., Dependency provider for ExploreService attached to application state. (+47 more)

## Knowledge Gaps
- **2627 isolated node(s):** `fs`, `path`, `fs`, `path`, `fs` (+2622 more)
...
- **Why does `DiscreteAllocationEngine` connect `DiscreteAllocationEngine` to `rebalance.py`, `GrowService`, `PortfolioState`, `TestDiscreteAllocationEngine`, `models.py`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `TestDiscreteAllocationEngine` connect `TestDiscreteAllocationEngine` to `DiscreteAllocationEngine`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `MarketDataService` connect `MarketDataService` to `RegimeService`, `GrowService`, `ParquetMarketCache`, `forecasting/service.py`, `test_grow_api.py`, `models.py`, `provider.py`, `MarketRegimeClassifier`, `test_end_to_end_integration.py`, `app.py`, `test_pwa_integration.py`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Are the 2 inferred relationships involving `TailwindConfigGenerator` (e.g. with `TestGeneratedConfigIsValidJs` and `TestTailwindConfigGenerator`) actually correct?**
  _`TailwindConfigGenerator` has 2 INFERRED edges - model-reasoned connections that need verification._
- **Are the 12 inferred relationships involving `MarketDataService` (e.g. with `SyncRequest` and `StockQuote`) actually correct?**
  _`MarketDataService` has 12 INFERRED edges - model-reasoned connections that need verification._
