...
## Corpus Check
- 567 files · ~534,263 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6345 nodes · 8806 edges · 529 communities (387 shown, 142 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 219 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `69e45dda`
...
## Communities (529 total, 142 thin omitted)
...
### Community 19 - "PortfolioService"
Cohesion: 0.10
Nodes (20): PortfolioService, Evaluate and return regime-shift rebalance recommendations., Apply recommended rebalance and update portfolio state., Export 1-click broker order sheet., List all active simulated portfolios from persistent repository., Delete portfolio from persistent repository and in-memory cache., Core domain service for Virtual Paper Portfolio tracking and rebalancing., Retrieve portfolio and refresh mark-to-market valuations. (+12 more)

### Community 20 - "simulation/service.py"
Cohesion: 0.14
Nodes (21): BrokerOrderItem, BrokerOrderSheet, RebalanceAlert, RebalanceItemDiff, Virtual Paper Portfolio Simulation and Rebalancing Engine., compute_rebalance_diff(), execute_rebalance(), generate_broker_order_sheet() (+13 more)
...
Cohesion: 0.08
Nodes (51): get_history(), get_returns_matrix(), get_universe(), BaseModel, get, post, Market Data REST API Routes., Retrieve aligned daily returns matrix for multiple assets. (+43 more)
...
Cohesion: 0.05
Nodes (66): get_explore_service(), get_growth_forecast(), get_stock_profile(), get_ticker_esg(), list_explore_stocks(), get, Request, Explore Tab REST API Routes for Stock Intelligence and Multi-Horizon Forecasts. (+58 more)
...
Cohesion: 0.10
Nodes (44): DeclarativeBase, BenchmarkComparisonLive, MarketRegimeType, PortfolioHolding, PortfolioState, RiskPersona, Base, DailySnapshotRecord (+36 more)
...
Cohesion: 0.06
Nodes (40): DatetimeIndex, FastAPI Application Factory for QuantNiti., BaseModel, Configuration settings for QuantNiti., Settings, High-performance Parquet-based market data cache., align_to_trading_calendar(), calculate_returns() (+32 more)

### Community 227 - "routes/portfolio.py"
Cohesion: 0.15
Nodes (24): apply_rebalance_endpoint(), calculate_compounding_endpoint(), create_portfolio_endpoint(), delete_portfolio_endpoint(), get_order_sheet_endpoint(), get_portfolio_endpoint(), get_portfolio_service(), get_rebalance_diff_endpoint() (+16 more)
...
Cohesion: 0.06
Nodes (47): Enum, AlertSeverity, LiteracyCategory, PushSubscriptionRequest, SmartAlert, SmartAlertType, evaluate_52w_high_breakout(), evaluate_drawdown_breach() (+39 more)
...
Cohesion: 0.13
Nodes (13): MarketTickGenerator, Any, Generate ticks for a list of symbols (or top universe symbols by default)., Format an SSE frame conforming to the W3C EventSource standard., Async generator yielding SSE formatted chunks with ticks and periodic pings., Generates continuous market price ticks with synthetic brownian motion or live…, Seed initial price, high, low, and volume states., Retrieve initial price from service or baseline defaults. (+5 more)
...
Cohesion: 0.09
Nodes (21): Batch-sync and cache historical market data for universe stocks., get_universe_symbols(), Return list of canonical symbols in the universe., Unit tests for Multi-Asset Universe Expansion (Ticket 17). Verifies asset…, Every asset in the 58-asset universe must have accessible historical OHLCV data., Factors must be successfully extracted for ETFs, Defense, and Metals., Taxonomy must define EQUITY, COMMODITY_ETF, and SECTORAL., Gold and Silver ETFs must be present with COMMODITY_ETF taxonomy. (+13 more)
...
Cohesion: 0.14
Nodes (18): calculate_parkinson_volatility(), calculate_realized_volatility(), calculate_rolling_log_returns(), extract_regime_features(), DataFrame, Series, Feature engineering for unsupervised market regime detection., Calculate rolling realized volatility of daily log returns. (+10 more)
...
Cohesion: 0.06
Nodes (48): apply_weight_caps(), compute_hrp_weights(), compute_shrunk_covariance(), get_cluster_variance(), get_quasi_diag_order(), DataFrame, ndarray, Hierarchical Risk Parity (HRP) Portfolio Allocation Engine. Implements the… (+40 more)
...
Cohesion: 0.05
Nodes (72): create_app(), Create and configure the FastAPI application instance., ParquetMarketCache, Return list of all cached symbols in the directory., Manages fast on-disk Parquet caching for historical OHLCV data., MockDataProvider, Deterministic synthetic market data provider for offline testing and…, Derive reproducible integer seed from symbol string. (+64 more)

### Community 421 - "PortfolioRepository"
Cohesion: 0.13
...
Cohesion: 0.06
Nodes (50): BacktestMetrics, BacktestTrade, RegimePerformanceBreakdown, BacktestEngine, BacktestResultData, compute_rsi(), Any, DataFrame (+42 more)

### Community 441 - "compounding_engine.py"
Cohesion: 0.09
Nodes (32): CompoundingMonthlyPoint, CompoundingRequest, CompoundingResponse, CompoundingTippingPoint, calculate_lump_sum(), calculate_monthly_sip(), calculate_step_up_sip(), compute_gbm_quantile_cones() (+24 more)
...
### Community 454 - "MarketDataProvider"
Cohesion: 0.17
Nodes (9): ABC, MarketDataProvider, DataFrame, Abstract Base Class for Market Data Providers., Fetch historical daily OHLCV dataframe for a given symbol., Fetch latest market quote for a given symbol., Live/EOD market data provider fetching from Yahoo Finance., Download historical price bars using Yahoo Finance. (+1 more)

### Community 455 - "._get_file_path"
Cohesion: 0.18
...
### Community 456 - "CurrentRegimeResponse"
Cohesion: 0.20
Nodes (9): CurrentRegimeResponse, RegimeHistoricalPoint, RegimeProbabilities, DataFrame, Fetch index & vix data, compute features, and ensure classifier is trained., Infer current active market regime, class probabilities, and diagnostic metrics., Compute full historical regime series and overall distribution., In High-Volatility Bear regimes, GrowService must include safe-haven ETFs with… (+1 more)
...
Cohesion: 0.10
Nodes (33): get_backtest_service(), get, post, Request, Quant Lab Technical Strategy Backtesting API endpoints., Alias for /backtest/run to support /quant-lab/backtest routing., Retrieve BacktestService instance from application state., Run technical strategy backtest via POST body. (+25 more)
...
Cohesion: 0.06
Nodes (47): get_grow_service(), get, post, Request, Grow and AI Portfolio Basket recommendation API endpoints., Retrieve GrowService instance from application state., Generate curated AI portfolio basket via POST body., Generate curated AI portfolio basket via GET query params. (+39 more)
...
### Community 489 - "test_alerts_api.py"
Cohesion: 0.24
Nodes (10): asyncio, Integration tests for Smart Alerts and Web Push API routes (Ticket #20)., Verify POST /api/v1/alerts/evaluate runs micro-batch evaluation., Verify VAPID public key and browser push subscription endpoints., Verify GET /api/v1/alerts retrieves active alerts., Verify PATCH /api/v1/alerts/{id}/read and DELETE /api/v1/alerts., test_evaluate_endpoint(), test_get_alerts_empty_and_populated() (+2 more)
...
### Community 504 - "compute_regime_suitability"
Cohesion: 0.29
...
### Community 506 - "test_tick_generator.py"
Cohesion: 0.20
Nodes (9): fixture, Unit tests for MarketTickGenerator and SSE tick formatting (Ticket #20)., Tick generator should produce a valid MarketTick with sensible price and volume., Tick generator should produce ticks for a batch of symbols., Multiple consecutive ticks should update price smoothly without wild jumps., test_generate_batch_ticks(), test_generate_single_tick(), test_tick_consecutive_price_movement() (+1 more)

### Community 508 - "FastAPI"
Cohesion: 0.28
Nodes (8): FastAPI, get_tick_generator(), get, Request, Server-Sent Events (SSE) streaming routes for real-time market data., Retrieve or lazily initialize MarketTickGenerator attached to app state., Server-Sent Events (SSE) endpoint broadcasting live market price ticks and…, stream_ticks()
...
### Community 510 - ".get_history"
Cohesion: 0.29
Nodes (5): DataFrame, Series, Get daily return series for a given ticker., Return a multi-asset aligned matrix (Date index, Columns = symbols) Uses NIFTY…, Get cleaned, validated OHLCV history with returns computed. Loads from local…
...
### Community 512 - "2. API and Composition Vocabulary"
Cohesion: 0.29
...
Cohesion: 0.33
Nodes (5): Unit tests for ESG Conscience Score dataset and universe integration., All 50 NIFTY constituents must have curated ESG scores., Badge mapping must adhere to: 🟢 >= 70, 🟡 40-69, 🔴 < 40., test_esg_badge_thresholds(), test_esg_data_covers_all_50_nifty_constituents()
...
### Community 520 - "Component Patterns"
Cohesion: 0.40
Nodes (5): Component Patterns, Dropdown Menu, Forms, Modal/Dialog, Tabs

### Community 521 - "get_current_regime"
Cohesion: 0.40
...
### Community 526 - "primary"
Cohesion: 0.67
Nodes (3): primary, $type, $value

### Community 527 - "get_market_service"
Cohesion: 0.67
Nodes (3): get_market_service(), Request, Dependency provider for MarketDataService attached to application state.

### Community 528 - "get_regime_service"
Cohesion: 0.67
Nodes (3): get_regime_service(), Request, Dependency provider for RegimeService attached to application state.
...
- **Why does `MarketDataService` connect `MarketDataService` to `MarketTickGenerator`, `backtest/service.py`, `data/service.py`, `test_multi_asset_universe.py`, `portfolio/service.py`, `alerts/service.py`, `MarketDataProvider`, `models.py`, `CurrentRegimeResponse`, `get_market_service`, `.get_esg_score`, `PortfolioService`, `forecasting/service.py`, `simulation/service.py`, `hrp.py`, `.get_history`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `RegimeService` connect `MarketDataService` to `backtest/service.py`, `GeminiClientAdapter`, `data/service.py`, `portfolio/service.py`, `assistant/service.py`, `alerts/service.py`, `PortfolioState`, `extract_regime_features`, `models.py`, `get_current_regime`, `CurrentRegimeResponse`, `MarketRegimeClassifier`, `get_regime_service`, `PortfolioService`, `forecasting/service.py`, `simulation/service.py`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `PortfolioRepository` connect `PortfolioRepository` to `test_portfolio_storage.py`, `PortfolioState`, `PortfolioService`, `simulation/service.py`, `MarketDataService`?**
