...
export const Step1Capital: React.FC<Step1CapitalProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <GlassCard className="p-6 space-y-6 bg-violet-950/20 border-violet-500/20">
        ...
        <div className="text-center space-y-1">
          <motion.div
            ...
            className="text-4xl sm:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-violet-300 via-fuchsia-200 to-indigo-200 tracking-tight"
          >
            {formatRupees(capital)}
          </motion.div>
          <p className="text-xs sm:text-sm font-medium text-violet-300/80">
        ...
        <div className="space-y-2">
          <input
            ...
            className="w-full h-2.5 bg-slate-800 rounded-lg appearance-none cursor-pointer accent-violet-500 hover:accent-violet-400 transition-all focus:outline-none focus:ring-2 focus:ring-violet-400/50"
          />
        ...
        {/* Quick Pick Chips */}
        <div className="space-y-2">
          <label className="text-xs font-semibold text-slate-300">Quick-Pick Amount</label>
        ...
        {/* Micro-Trust Chip */}
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-950/40 border border-emerald-500/30 text-emerald-300 text-xs font-medium">
