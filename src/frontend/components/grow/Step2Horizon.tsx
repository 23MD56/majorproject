              ...
              <div className="flex items-start justify-between gap-2">
                <div className="space-y-0.5">
                  <div className="flex items-center gap-2">
                    ...
                    {opt.recommended && (
                      <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-violet-500/25 border border-violet-400/30 text-[10px] font-semibold text-violet-300">
                        <Star className="w-2.5 h-2.5 fill-violet-300" />
                        Recommended
                      </span>
                    )}
                  </div>
                  <span className="text-xs font-medium text-violet-400">{opt.stance}</span>
                </div>
